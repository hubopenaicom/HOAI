...
<template>
  <div>
    ...
    <page-main class="flex flex-wrap items-start justify-between gap-4">
      <div class="fa-admin-toolbar min-w-0 flex-1">
      <el-form ref="formRef" :inline="true" :model="formInline">
        ...
        <el-form-item>
          <el-button type="primary" @click="queryAllOrder">
      ...
      <el-statistic class="shrink-0" title="累计已支付订单金额" :value="totalPrice" />
    </page-main>
