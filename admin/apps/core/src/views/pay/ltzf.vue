<script lang="ts" setup>
  ...
  const rules = computed<FormRules>(() => {
    const isPayEnabled = formInline.payLtzfStatus === '1';

    return {
      payLtzfStatus: [{ required: true, trigger: 'change', message: '请选择当前支付开启状态' }],
      payLtzfSecret: [{ required: isPayEnabled, trigger: 'blur', message: '请填写商户秘钥' }],
      payLtzfMchId: [{ required: isPayEnabled, trigger: 'blur', message: '请填写商户号' }],
      payLtzfNotifyUrl: [
  ...
  <div>
    <PageHeader>
      ...
      <template #content>
        <div class="text-sm/6">
          <div>
            <a href="https://www.ltzf.cn/?invite=beraqu" target="_blank">蓝兔支付</a>
            为第三方支付，接入请购买微信渠道。
          </div>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="启用当前支付" prop="payLtzfMchId">
              <el-switch v-model="formInline.payLtzfStatus" active-value="1" inactive-value="0" />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="商户号" prop="payLtzfMchId">
              <el-input v-model="formInline.payLtzfMchId" placeholder="请填写商户号" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="商户密钥" prop="payLtzfSecret">
              <el-input v-model="formInline.payLtzfSecret" placeholder="请填写商户秘钥" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
