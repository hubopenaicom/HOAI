  ...
  <div>
    ...
    <el-card class="fa-admin-card">
      <el-form ref="formRef" :model="formInline" label-width="120px">
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="SecretId" prop="cosSecretId" :rules="customRules">
              <el-input
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="SecretKey" prop="cosSecretKey" :rules="customRules">
              <el-input
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="存储桶名称" prop="cosBucket" :rules="customRules">
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="所属地域" prop="cosRegion" :rules="customRules">
              <el-input
