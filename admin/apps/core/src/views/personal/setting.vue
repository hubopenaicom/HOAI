...
<template>
  <div>
    <PageHeader title="个人设置" description="管理账号安全与偏好设置" />
    <page-main>
      <div class="rounded-xl border border-border bg-card p-3 shadow-sm md:p-4">
      <el-tabs tab-position="left" class="min-h-[520px] md:min-h-[600px]">
        ...
        <el-tab-pane label="安全设置" class="security">
          ...
          <div class="setting-list">
            <div class="item">
              ...
              <div class="action">
                <FaButton variant="link" class="h-auto px-0" @click="editPassword">修改</FaButton>
              </div>
            </div>
            <!-- <div class="item">
              <div class="content">
