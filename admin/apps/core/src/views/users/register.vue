<script lang="ts" setup>
  ...
  const rules = ref<FormRules>({
    ...
    signInModel3Count: [{ required: true, trigger: 'blur', message: '请填写赠送的基础模型额度' }],
    signInModel4Count: [{ required: true, trigger: 'blur', message: '请填写赠送的高级模型额度' }],
    signInMjDrawToken: [{ required: true, trigger: 'blur', message: '请填写赠送的绘画Token数量' }],
  ...
  <div>
    ...
    <el-card class="fa-admin-card">
      <el-form ref="formRef" :rules="rules" :model="formInline" label-width="220px">
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册赠送基础模型对话额度" prop="registerSendModel3Count">
              <el-input
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册赠送高级模型对话额度" prop="registerSendModel4Count">
              <el-input
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="注册赠送绘画额度" prop="registerSendDrawMjCount">
              <el-input
