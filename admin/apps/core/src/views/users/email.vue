<script lang="ts" setup>
  ...
  const rules = ref<FormRules>({
    MAILER_HOST: [{ required: true, trigger: 'blur', message: '请填写SMTP服务器地址' }],
    MAILER_PORT: [{ required: true, trigger: 'blur', message: '请填写SMTP服务器端口' }],
    MAILER_USER: [{ required: true, trigger: 'blur', message: '请填写SMTP用户名称' }],
    MAILER_PASS: [{ required: true, trigger: 'blur', message: '请填写SMTP用户密码' }],
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="SMTP服务器端口" prop="MAILER_PORT">
              <el-input v-model="formInline.MAILER_PORT" placeholder="示例: 465" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="SMTP用户名称" prop="MAILER_USER">
              <el-input v-model="formInline.MAILER_USER" placeholder="SMTP认证用户名" clearable />
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row>
          <el-col :xs="24" :md="20" :lg="15" :xl="12">
            <el-form-item label="邮箱SSL配置" prop="MAILER_SECURE">
              <el-checkbox v-model="formInline.MAILER_SECURE" true-label="1" false-label="0">
                启用SSL
              </el-checkbox>
            </el-form-item>
          </el-col>
